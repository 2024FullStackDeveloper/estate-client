...
const Footer = () => {
  ...
  const footerLinks = {
    company: [
      ...
      { name: "Our Services",nameAr:"خدماتنا", href: "#" },

      { name: "About Us", nameAr:"من نحن", href: "#" },
    ],
    
    legal: [
      { name: "Privacy Policy",nameAr:"سياسة الخصوصية", href: "#" },
      { name: "Terms of Service", nameAr:"شروط الخدمة", href: "#" },
    ],
  };
    ...
    <footer className="bg-nav">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-sm text-footer-muted">
                ...
                <p>{isRTL ? "جدة" : "Jeddah"}</p>
                <p>{isRTL ? "شارع طلال بن عبدالعزيز" : "Talal Bin Abdulaziz Street"}</p>
              </div>
              <div className="space-y-1 text-sm text-footer-muted">
                <p>{isRTL ? "رقم الهاتف" : "Phone number"} : (555) 123-4567</p>
                <p>{isRTL ? "البريد الالكتروني":"Email"} : test@company.com</p>
              </div>
            </div>
          </div>
          ...
          {/* Company Links */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider">{isRTL ? "الشركة" : "Company"}</h4>
          ...
          {/* Legal Links */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider">{isRTL ? "سياسة الموقع": "Legacy"}</h4>
            <ul className="space-y-2">
