...
const MainSection: React.FC = () => {
  ...
  return (
    <div className=" w-full">
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center justify-center my-10 z-10">
        <ScrollSection animationType="scale">
          <div className=" flex flex-col gap-4 px-1 relative order-2">
            <Ball className="animate-ping" />
            <Title title={t("titles.intro")} className="underline" />
            <TextDecorator
              className="lg:text-5xl text-3xl font-bold my-2"
              values={[
                {
                  text: isRTL
...
`}
            ...
            <TextDecorator
              ...
              values={[
                {
                  text: isRTL
                    ? "بداية سلم النجاح خطوة"
                    : "The beginning of the ladder of success is one step.",
                },
                {
                ...
                },
                {
                  ...
                  className: "italic font-normal text-primary -skew-x-12 px-1 ",
                },
                {
                  text: ".",
                },
        ...
        <div className="w-full h-[400px] md:h-full order-1 ">
          <FrameBox imageUrl1="images/building.jpg" />
        </div>
      </section>
    </div>
  );
